...
func (a *Api) TufTargetMetadataRefresh(factory string, target string, tag string, expiresIn int, prod bool, wave string, bundleTargets *tuf.Signed) (map[string]tuf.Signed, error) {
